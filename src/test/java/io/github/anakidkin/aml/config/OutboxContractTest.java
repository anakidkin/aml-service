...
class OutboxContractTest {
  ...
  void shouldCorrectlySerializeAndDeserializeOutboxPayload() throws Exception {
    ...
    TransactionEvaluatedEvent originalEvent =
    ...
    TransactionEvaluatedEvent deserializedEvent =
        objectMapper.readValue(payloadJson, TransactionEvaluatedEvent.class);
