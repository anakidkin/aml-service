...
public class AccountTransactionHistoryEntity {
  ...
  @PrimaryKeyColumn(name = "is_p2p", type = PrimaryKeyType.CLUSTERED, ordering = Ordering.ASCENDING, ordinal = 1)
  private boolean isP2p;

  @PrimaryKeyColumn(name = "created_at", type = PrimaryKeyType.CLUSTERED, ordering = Ordering.DESCENDING, ordinal = 2)
  private Instant createdAt;

  @PrimaryKeyColumn(name = "transaction_id", type = PrimaryKeyType.CLUSTERED, ordering = Ordering.ASCENDING, ordinal = 3)
