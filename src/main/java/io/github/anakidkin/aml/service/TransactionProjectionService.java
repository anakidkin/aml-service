...
/**
 * Service-projection responsible for processing and storing transaction history
 * and audit logs from outbox event streams.
 */
public interface TransactionProjectionService {

  /**
   * Processes a transaction evaluation event and persists denormalized data
