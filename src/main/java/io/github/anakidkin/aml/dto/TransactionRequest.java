...
/**
 * Inbound Data Transfer Object representing an external request to evaluate a financial transaction.
 *
 ...
 * @param mccCode     Four-digit Merchant Category Code classification (e.g., "6012" for financial institutions, "7995" for gambling).
 * @param isP2p       Flag indicating whether the transaction is a Person-to-Person (P2P) transfer. Defaults to false if omitted.
 */
public record TransactionRequest(
    ...
    @NotNull(message = "isP2p flag must be provided")
    Boolean isP2p
) {
